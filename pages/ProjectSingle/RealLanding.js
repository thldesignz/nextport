                    ...
                    <div className="col-lg-8 offset-lg-2">
                        <div className="wpo-minimal-wrap">
                            <div className="wpo-minimal-img">
                                <img src='https://flawlessjae.net/wp-content/uploads/2021/08/Screen-Shot-2021-08-05-at-12.12.07-PM.png' alt=""/>
                            </div>
                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="co-l-lg-4 col-md-4 col-sm-6 col-12">
                                    <div className="wpo-project-details-text">
                                        ...
                                        <h2><a target="_blank" href="https://real-landing-xi.vercel.app/">Click Here</a></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="wpo-p-details-section">
                            <p>This is a landing page that i built using react and nextJS. This is only the landing page right now. in the future i will have a full stack site built out using this landing page. </p> 
                            {/* <div className="row">
